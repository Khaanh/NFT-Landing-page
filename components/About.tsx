	...
	return (
		<div className="pt-[5rem] pb-[3rem] bg-blue-950">
			<div className="w-[80%] mx-auto grid grid-cols-1 xl:grid-cols-2 items-center gap-[3rem]">
				<div className="md:w-[500px] md:h-[600px] w-[80%] h-[80%] border-[3px] flex items-center justify-center border-gray-400 rounded-lg">
					<Image
				...
				<div>
					...
					<p className="text-[15px] md:text-[17px] mt-[1rem] mb-[1rem] text-white opacity-80">
						...
						corrupti quasi deserunt accusantium a illo sint enim, temporibus
						voluptate hic omnis eveniet praesentium atque cum odit iste corporis
						est debitis!
					</p>
					<p className="text-[15px] md:text-[17px] mt-[1rem] mb-[1rem] text-white opacity-80">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat
