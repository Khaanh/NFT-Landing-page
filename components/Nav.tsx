			...
			<div className="w-[90%] flex items-center h-[100%] justify-between mx-auto">
				...
				<div className="flex items-center space-x-4">
					...
					<div className="w-[2rem] hover:bg-red-600 relative cursor-pointer transition-all duration-200 h-[2rem] sm:w-[3.4rem] sm:h-[3.4rem] rounded-full flex items-center justify-center bg-[#0000003d]">
						...
						<span className="w-[0.7rem] h-[0.7rem] sm:w-[1.1rem] sm:h-[1.1rem] text-[10px] sm:text-[13px] absolute top-0 right-0 flex items-center justify-center bg-red-600 rounded-full text-white">
							4
						</span>
					</div>
